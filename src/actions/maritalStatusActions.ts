...
export const getAll = () => async (dispatch: Function) => {
  ...
  try {
    const { data: { data }, status } = await MaritalStatus.getAll();
    let response = [];
    if (status === 200) {
      response = data;
      dispatch({
...
export const search = (term: string) => async (dispatch: Function) => {
  ...
  try {
    const { data: { data }, status } = await MaritalStatus.search(term);
    let response = [];
    if (status === 200) {
      response = data;
      dispatch({
...
export const create = (body: object) => async (dispatch: Function) => {
  ...
  try {
    const apiResponse = await MaritalStatus.create(body);
    ...
    if (status === 200 || status === 201) {
      ...
      snackBarUpdate({
        payload: {
          message: "Marital Status ha sido Registrado!",
          type: "success",
          status: true
        }
      })(dispatch);
...
export const get = (id: number) => async (dispatch: Function) => {
  try {
    const { data: { data }, status } = await MaritalStatus.get(id);
    let response = [];
    if (status === 200) {
      response = data;
    }
...
export const update = (body: object) => async (dispatch: Function) => {
  ...
  try {
    const { data, status } = await MaritalStatus.update(body);
    let response: any = [];
    if (status === 200) {
      response = {
        data,
      ...
      snackBarUpdate({
        payload: {
          message: "Marital Status ha sido Actualizado!",
          type: "success",
          status: true
        }
      })(dispatch);
...
export const remove = (id: number) => async (dispatch: Function) => {
  try {
    const { data, status } = await MaritalStatus.remove(id);
    let response: any = [];
    if (status === 200) {
      response = {
        data,
      ...
      snackBarUpdate({
        payload: {
          message: "Marital Status ha sido Elmiminado!",
          type: "success",
          status: true
        }
      })(dispatch);
